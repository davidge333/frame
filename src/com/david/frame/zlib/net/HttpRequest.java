...
import com.david.frame.utils.BaseUtils;
import com.david.frame.utils.JsonUtil;
		...
		try {
			...
			if (statusCode == HttpStatus.SC_OK) {
				...
				if ((requestCallback != null)) {
					final Response responseInJson = (Response) JsonUtil.jsonToBean(strResponse, Response.class);
